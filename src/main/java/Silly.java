...
public class Silly implements Comparable<Silly> {
     ...
     * @param scnd_string  a string for this Silly instance's name.
     */

    public Silly(String first_string, String scnd_string) {
        this.name = first_string + scnd_string;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Silly)) {
            return false;
        } else if (other.toString().equals(this.name)){
            return true;
        } else{
            return false;
        }
